...
The actual vignette is available here:
<https://bookdown.org/brry/rdwd>

* it has grown too big for CRAN 
* the constant rebuilding is an unnecessary load on the DWD FTP Server
* The bookdown page enables a very nicely structured html layout
