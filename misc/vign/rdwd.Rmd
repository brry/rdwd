...
[Vignette Rmd source code](https://github.com/brry/rdwd/blob/master/misc/vign/rdwd.Rmd)
...
by geographical location (see [map](mapDWD.html) and [`nearbyStations`](../help/nearbyStations)), by temporal resolution (**res** = 1/10 minutes, hourly, daily, monthly, annual), 
...
lapply(selectDWD(id=c(3467,5116), res="",var="",per=""), substr, 76, 1e4)
```
...
substr(m_link, 76, 1e4) # (Monatswerte = monthly values, Beschreibung = description)
```
```{r meta2, eval=FALSE}
