...
soilIndex <- indexFTP(folder="soil/daily", base=dbase, dir="../localdata")
soilIndex <- createIndex(soilIndex, base=dbase, dir="../localdata")
...
# Add monthly data:
soilIndexm <- indexFTP(folder="soil/monthly", base=dbase, dir="../localdata")
soilIndexm <- createIndex(soilIndexm, base=dbase, dir="../localdata")
soil_link <- c(soil_link, selectDWD("Potsdam", res="", var="", per="",
                                    base=dbase, findex=soilIndexm))

# download and read files:
soil_data <- dataDWD(soil_link, base=dbase, dir="../localdata")
...
dbase <- "ftp://opendata.dwd.de/climate_environment/CDC/derived_germany"
soil_index <- indexFTP(folder="soil/daily", base=dbase, dir="../localdata")
soil_index <- createIndex(soil_index, base=dbase, dir="../localdata")
soil_links <- selectDWD(res="soil", var="daily", per="r", base=dbase, findex=soil_index)
soil_data <- dataDWD(soil_links, base=dbase, dir="../localdata")
```
