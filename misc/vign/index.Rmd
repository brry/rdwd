...
[ftp://opendata.dwd.de/climate_environment/CDC/observations_germany/climate/hourly/wind/recent/stundenwerte_FF_00164_akt.zip](ftp://opendata.dwd.de/climate_environment/CDC/observations_germany/climate/hourly/wind/recent/stundenwerte_FF_00164_akt.zip)
...
for(i in 2:ncol(f)) fu[-1,i] <- ifelse(f[-1,i]=="", " ", 
    paste0('<a href="',dwdbase,'/',colnames(f)[i],'/',f[-1,1],'" target="_blank">',f[-1,i],'</a>'))
...
there's yet more data at <ftp://opendata.dwd.de/weather>.
...
From the [monthly](ftp://opendata.dwd.de/climate_environment/CDC/grids_germany/monthly) 
...
Single RW files at <ftp://opendata.dwd.de/weather/radar/radolan/rw> should be read
