...
- USA data: [countyweather](https://www.rdocumentation.org/packages/countyweather),
          [rnoaa](https://docs.ropensci.org/rnoaa/)

- World data: [Global Surface Summary of the Day](https://ropensci.org/blog/blog/2017/04/04/gsodr)

- Dutch data (Netherlands): [KNMIr](https://github.com/bvhest/KNMIr)

- Canadian data: [weathercan](https://cran.r-project.org/package=weathercan)

- UK data [website](https://www.metoffice.gov.uk/climate/uk/data)

- The Python equivalent of rdwd: the package [wetterdienst](https://github.com/earthobservations/wetterdienst)
by the *Catchment Attributes and MEteorology for Large-sample Studies* initiative 
([CAMELS](https://zenodo.org/record/6517142)).
It also covers Radolan and Radvor and has local caching (even with an SQL interface), but has many dependencies. 
