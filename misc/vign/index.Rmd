...
For time series there is no overarching plotting function and raster data must as of yet be selected manually.
...
```{r mindexupdate}
ll <- selectDWD("Potsdam", c("hourly","daily"), c("wind","kl"), "r", meta=TRUE)
ll <- sub(dwdbase, "", ll)
ll
