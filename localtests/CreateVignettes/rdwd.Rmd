...
Raster and binary reading functions are included since `rdwd 1.1.0` (March 2019), although the latter doesn't read the radolan binary files completely correct yet, see [Development notes](https://github.com/brry/rdwd/blob/master/localtests/developmentNotes.R#L82).
...
[rdwd-package.R](https://github.com/brry/rdwd/blob/master/R/rdwd-package.R#L241).
