...
Raster and binary reading functions are included since `rdwd 1.1.0` (March 2019), although the latter doesn't read the radolan binary files completely correct yet, see [`?readDWD.binary`](../help/readDWD.binary).
...
[rdwd-package.R](https://github.com/brry/rdwd/blob/master/R/rdwd-package.R#L246).
...
To request those, please contact <cdc.daten@dwd.de>.
